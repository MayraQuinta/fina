                      ...
                      <div class="col-md-12">
                        <form class="cmxform" id="signupForm" method="get" action="" novalidate="novalidate">
                          <div class="col-md-6">
                            ...
                            <div class="form-group form-animate-text" style="margin-top:40px !important;">
                              <input type="text" class="form-text" id="validate_lastname" name="validate_lastname" required="" aria-required="true">
                              <span class="bar"></span>
                        ...
                        <label>Teléfono</label>
                          ...
                          <div class="col-md-6">
                            <div class="form-group form-animate-text" style="margin-top:40px !important;">
                              <input type="password" class="form-text" id="validate_password" name="validate_password" required="" aria-required="true">
                              <span class="bar"></span>
...
<div class="form-group form-animate-text" style="margin-top:40px !important;">
                              <input type="text" class="form-text mask-dui" id="validate_username" name="validate_username" required="" aria-required="true">
                              <span class="bar"></span>
                              <label>DUI</label>
                            </div>
                        ...
                        <div class="form-animate-radio">
                          <label class="radio">
                            ...
                            <span class="outer">
                              <span class="inner"></span></span> Femenino
                            </label>
                             <label class="radio">
                            <input id="radio1" type="radio" name="radios">
                            <span class="outer">
                              <span class="inner"></span></span> Masculino
                            </label>
                          </div>
