...
if (isset($_REQUEST['id_prestamo'])) {
    $id_prestamo = $_REQUEST['id_prestamo'];
        ...
        echo "<script>
        location.href='credito_refinanciado_natural.php?id_prestamo='".$id_prestamo." ;
        </script>";
    ...
    <div class="container-fluid">
        <div class="panel" name="libros">
            <div class="panel-heading text-center">
                <div class="row">
                    <div class="col-md-12">
                        <h3>Crédito de Refinanciamiento Natural</h3>
                    </div>
                </div>
            </div>
            <div class="panel-body">  
                    ...
                    <tbody>
                        ...
                        <?php } ?>
                         <?php foreach ($lista_prestamo_natural as $lista2) { ?>
                            <tr>
                               <td class="text-center">
                                   <button class="btn btn-danger" onclick="refinanciar('<?php echo $lista['6'];?>'"> 
                                     <i class="fa fa-money"></i> 
                                    </button>
                                </td>
...
function refinanciar(id_prestamo ,id_juridico ){
    location.href="credito_refinanciado_natural.php?id_prestamo=" +id_prestamo+"&id_natural="+id_natural,"_parent";
}
